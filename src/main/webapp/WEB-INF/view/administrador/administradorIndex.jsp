...
<header class="cabecalho">
    <nav>
        ...
        <ul class="menu">
            <li><a href="/administrador/listaChamadosAdmin">Acompanhar Chamados</a></li>
            <li><a href="/cadusuario">Gerenciar Usuários</a></li>
...
<main>
    ...
    <section data-content class="empreenIndex">
        ...
        <div class="empreendimento" data-slider="empreend">
            ...
            <figure><img style="position:relative; left: 1%" src="/img/img-admin.jpg"></figure>
