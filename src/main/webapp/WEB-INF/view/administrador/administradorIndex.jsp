...
<header class="cabecalho">
    <nav>
        ...
        <ul class="menu">
            <li><a href="acompanhaChamado.php">Acompanhar Chamados</a></li>
            <li><a href="gerenciausuarios.php">Gerenciar Usuários</a></li>
            <li><a href="relatorio.php">Relatório de Chamados</a></li>


        </ul>
        <label class="search">
            <input type="search" name="pesquisar"/>
            <a><img src="icons/button.png"></a>
        </label>
    </nav>
</header>
<script>
    document.querySelector('span[title="button-menu"]').addEventListener('click', function () {
        this.closest('nav').getElementsByTagName('UL')[0].classList.toggle('ativo'); }, false);
...
<main>
    ...
    <section data-content class="empreenIndex">
        <h1 class="title-secao">ÁREA DO ADMINISTRADOR</h1>
        <div class="empreendimento" data-slider="empreend">


            <figure><img style="position:relative; left: 17%" src="img/img-admin.jpg"></figure>
