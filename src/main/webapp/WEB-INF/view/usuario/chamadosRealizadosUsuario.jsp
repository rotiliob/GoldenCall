...
<header class="cabecalho">
    <nav>
        ...
        <ul class="menu">
            <li><a href="_areatecnico.html">Início</a></li>
            <li><a href="_listaChamados.html">Lista de Chamados</a></li>
            <li><a href="#">Meus Chamados Realizados</a></li>
        ...
        <div class="empreendimento" data-slider="empreend">
            ...
            <table class="tg">
                <tr>
                    ...
                    <a href="/usuario/usuarioIndex">Novo Chamado</a>
                </tr>
                ...
                <!-- Aqui entra um Loop For , fazendo um select * from chamados where AtendenteChamado  == usuario.matricula AND status == 'aberto' -->
